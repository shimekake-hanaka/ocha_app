if defined?(AssetSync)
  AssetSync.configure do |config|
    ...
    config.aws_access_key_id = ENV['AWS_S3_BUCKET_NAME']
    config.aws_secret_access_key = ENV['d5T065neFoMERApN/32mcvaVfxe88bSadWuP7/aU']
    ...
    config.fog_directory = ENV['ochaapp']
